    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('base_model', models.CharField(default=drip.utils.get_user_model, help_text=b'Base model to filter', max_length=255, blank=True)),
                ('user_field', models.CharField(default=b'', help_text=b'User field on base model to use as user', max_length=255, blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
